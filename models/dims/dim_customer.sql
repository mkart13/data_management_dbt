...
JOIN {{ ref('stage_address') }} a ON c.address_id = a.address_id
JOIN {{ ref('stage_city') }} ci ON a.city_id = ci.city_id
JOIN {{ ref('stage_country') }} co ON ci.country_id = co.country_id
